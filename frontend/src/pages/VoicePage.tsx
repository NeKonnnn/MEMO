        ...
        if (typeof event.data === 'string') {
          ...
          switch (data.type) {
            ...
            case 'ai_response':
              ...
              showNotification('success', 'Получен ответ от AI');
              break;
  ...
  const sendVoiceMessage = async (text: string) => {
    try {
      ...
      if (result.success) {
        ...
        showNotification('error', 'Ошибка получения ответа от AI');
      }
    } catch (error) {
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                Общайтесь с AI ассистентом голосом
              </Typography>
            </Box>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                {isRecording 
                  ...
                  : isProcessing || isSpeaking
                    ? 'Микрофон заблокирован пока AI обрабатывает ваш запрос...'
